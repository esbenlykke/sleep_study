...
plot_proxy <-
  ...
  labs(
    ...
    subtitle = "Determined by <span style='color:lightblue'>Standard Deviation Threshold</span> *(n<sub>nights</sub> = 477)* and <span style = 'color:darkorange'>Static Time Stamps</span> *(n<sub>nights</sub> = 12)*",
    x = NULL,
    y = NULL
  ) +
  theme(
