...
flow <-
  ...
  # main boxes
  geom_rect(
    xmin = 10, xmax = 50, ymin = 117, ymax = 127, color = "#4DBBD5",
  ...
  geom_rect(
    xmin = 10, xmax = 50, ymin = 92, ymax = 102, color = "#4DBBD5",
    fill = "white", linewidth = 0.25
  ) +
  annotate("text",
           x = 30, y = 97,
  ...
  geom_rect(
    xmin = 10, xmax = 50, ymin = 67, ymax = 77, color = "#4DBBD5",
    fill = "white", linewidth = 0.25
  ) +
  annotate("text",
  ...
  geom_rect(
    xmin = 10, xmax = 50, ymin = 42, ymax = 52, color = "#4DBBD5",
    fill = "white", linewidth = 0.25
  ) +
  annotate("text",
  ...
  geom_rect(
    xmin = 10, xmax = 50, ymin = 17, ymax = 27, color = "#4DBBD5",
    fill = "white", linewidth = 0.25
  ) +
  annotate("text",
  ...
  # boxes to the side
  geom_rect(
    xmin = 45, xmax = 85, ymin = 104.5, ymax = 114.5, color = "#4DBBD5",
    fill = "white", linewidth = 0.25
  ) +
  annotate("text",
           x = 65, y = 109.5,
  ...
  geom_rect(
    xmin = 45, xmax = 85, ymin = 79.5, ymax = 89.5, color = "#4DBBD5",
    fill = "white", linewidth = 0.25
  ) +
  annotate("text",
           x = 65, y = 84.5,
  ...
  geom_rect(
    xmin = 45, xmax = 85, ymin = 54.5, ymax = 64.5, color = "#4DBBD5",
    fill = "white", linewidth = 0.25
  ) +
  annotate("text",
           x = 65, y = 59.5,
  ...
  geom_rect(
    xmin = 45, xmax = 85, ymin = 29.5, ymax = 39.5, color = "#4DBBD5",
    fill = "white", linewidth = 0.25
  ) +
  annotate("text",
           x = 65, y = 34.5,
