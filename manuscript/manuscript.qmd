...
SPT[@doherty2017; @anderson2014]. We have attempted to circumvent this
issue by employing models able to distinguish between in-bed awake time
and in-bed asleep time over a 24h recording making our models capable of
estimating all commonly used sleep quality parameters. Van Hees et
al.[@van_hees_estimating_2018] have developed an algorithm to identify
SPT from wrist-worn devices which was recently validated by Plekhanova
and colleagues[@plekhanova2023]. which in combination with other
algorithms or models on said SPT can then be used infer further sleep
quality parameters.
...
applicability for researchers that want to ...
