...
and sensitivity. However, Specificity values are not available for this
configuration. With 10-minute median filtering, F1 Scores range from
73.45% to 73.93%, maintaining good performance but with limited
information on Specificity. Further analysis is required to assess
...
## Evaluation of Sleep Quality Summaries
