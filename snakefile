...
zm_files = os.listdir("/media/esbenlykke/My Passport/sleep_study/data/raw/screens_zmachine")
...
list_file_bsl = open("/media/esbenlykke/My\ Passport/sleep_study/data/processed/bsl_children_cwa.txt", "r")
...
#     data = expand("/media/esbenlykke/My Passport/sleep_study/data/raw/screens_zmachine/{zm_files}", zm_files=zm_files)
#   output:
#     "data/processed/zm_scores.tsv"
#   shell:
#     "{input.r_script}"
...
#     bsl_info = "/media/esbenlykke/My Passport/sleep_study/data/participant_info/screens_baseline_info.xlsx",
#     fup_info = "/media/esbenlykke/My Passport/sleep_study/data/participant_info/screens_followup_info.xlsx",
...
rule filter_join_included_zm_data:
  input:
    ...
    "code/prepare_data/remove_excluded_zm_data.R"
  output:
    "data/processed/fup_thigh_no_bad_zm.parquet"
  shell:
    "code/prepare_data/remove_excluded_zm_data.R"
